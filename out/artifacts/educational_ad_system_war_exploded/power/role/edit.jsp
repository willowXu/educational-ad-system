...
<div class="cztable">
	<form action="/power/role/roles?method=update&roleId=${role.roleId}" method="post">
                ...
                <tr  width="120px;">
                    ...
                    <td>
                        ...
                        <c:forEach items="${menuList}" var="m1">
                        	...
                        	<li ><input type="checkbox" name="menu"  value="${m1.menuId}" ${m1.selected==1?'checked':''} />${m1.menuName}
                            	<ul>
                                    <c:forEach items="${m1.secondMenuList}" var="m2">
                                	<li>&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="menu" value="${m2.menuId}" ${m2.selected==1?'checked':''}  />${m2.menuName}</li>
                                    </c:forEach>
                                </ul>
                            </li>
                        </c:forEach>
